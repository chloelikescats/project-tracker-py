...
def get_project_by_title(title):
    ...
    print "Project: {title}; description: {description}.".format(title=row[0],
                                                          description=row[1])
...
def get_grade_by_github_title(github, title):
    ...
    print "Project Grade: {grade}".format(grade=row[0])
...
def assign_grade(github, title, grade):
    ...
    print "Successfully added grade: {github} for {title} earned {grade} points".format(
